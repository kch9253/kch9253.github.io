...
class SignUp extends JDialog implements MouseListener {
	...
	public SignUp(JFrame owner) {
		...
		icon = new ImageIcon("d:\\회원가입아이콘1.png");
		...
		JButton btnNewButton_1 = new JButton(new ImageIcon("d:\\검색아이콘.png")); // 중복확인 버튼
		...
		JButton btnNewButton = new JButton(new ImageIcon("d:\\완료버튼.png")); // 가입완료 버튼
		...
		JLabel lblNewLabel = new JLabel(new ImageIcon("d:\\아이디1.png"));
		...
		JLabel lblNewLabel_1 = new JLabel(new ImageIcon("d:\\패스워드.png")); // 패스워드라벨
		...
		JLabel lblNewLabel_2 = new JLabel(new ImageIcon("d:\\패스워드.png")); // 패스워드라벨
		...
		JLabel lblNewLabel_3 = new JLabel(new ImageIcon("d:\\이름아이콘.png")); // 이름라벨
		...
		JButton btnNewButton_2 = new JButton(new ImageIcon("d:\\돌아가기.png"));
