...
<div id="mySidenav" class="sidenav">
  ...
  <a href="./FavoriteSearch.jsp">돌아가기</a>
</div>
...
// String sql = "select * from favorite as A join mapapi as B on A.latclick = B.latclick where A.latclick=?";
...
<h2> <정보> </h2>
    ...
    <br>
    <br>
    <label>전화번호 :  <input type="text" id="number" style="width: 200px" name="number" value="<%=number%>"disabled > <a href="<%=homepage %>" target='_blank'>홈페이지</a>
	<br>
	<br>
