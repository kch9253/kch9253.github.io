...
<br>
	...
	<br>
	<br>
    <label>상호명 :  <input type="text" id="pname" style="width: 200px" name="pname" value="<%=pname%>" disabled> 
    <br>
    <br>
    <label>주소 :  <input type="text" id="paddress" style="width: 200px" name="paddress"  value="<%=paddress%>"disabled >  <a href="<%=route%>">길찾기</a>
    <br>
    <br>
    <label>전화번호 :  <input type="text" id="number" style="width: 200px" name="number" value="<%=number%>"disabled > 
	<br>
	<br>
