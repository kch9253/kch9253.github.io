...
<form id="frm" name="frm" action="MapManager_DB.jsp" method="post">
	<center>
	<h2>메인입력</h2>
    <label>상호명 :<input type="text" id="pname" name="pname" value="${ param.pname }" > 
    <br>
    <br>
    <label>주소 :<input type="text" id="paddress" name="paddress" value="${ param.paddress }" >  
    <br>
    <br>
    <label>좌표ID값 :<input type="text" id="latclick" name="latclick" value="${ param.latclick }" > 
    <br>
    <br>
    <label>좌표위도 :<input type="text" id="lngclick" name="lngclick" value="${ param.lngclick }" >
...
<form action="MapManagerInsert_DB.jsp" method="post">
	<label>좌표ID값 :<input type="text" id="latclick1" name="latclick" value="${ param.latclick }" > 
	<br>
	<br>
    <label>전화번호 :<input type="text" id="number" name="number" value="${ param.number }" > 
	<br>
	<br>
	<label>영업시간 :<input type="text" id="opentime" name="opentime" value="${ param.opentime }" > 
	<br>
	<br>
	<label>카테고리 :<input type="text" id="category" name="category" value="${ param.category }" > 
	<br>
	<br>
	<label>이미지 :<input type=url id="img" name="img" value="${ param.img }" > 
