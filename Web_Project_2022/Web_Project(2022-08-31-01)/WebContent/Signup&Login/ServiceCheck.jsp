...
<div id="d1">
 ...
 <div id="accordion">
   ...
   <h3><a href="#"><font size="2">김창희프로젝트 이용약관 동의(필수)</font><input type="checkbox" name="c1" id="c1"/></a></h3>
...
6. 이용자 보호 및 부정 이용 방지: 개인위치정보주체 또는 이동성 있는 기기의 위치를 이용하여 권한없는 자의 비정상적인 서비스 이용 시도 등을 차단합니다.
 ...
 <div align="center">
  <br/>
  <input type="submit" value="동의"><input type="reset" value="비동의"><input type="button" value="돌아가기" onclick="location.href='Login.jsp'">
