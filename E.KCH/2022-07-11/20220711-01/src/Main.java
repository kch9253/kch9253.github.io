...
class Student implements Serializable { // Serializable = 직렬화가능 인터페이스
	private String name;				// 직렬화 = 흩어져있는 개체들을 하나로 모아주는
	private int age;
	private transient double score; // 직렬화대상에서 제외 = transient
