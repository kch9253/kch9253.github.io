public class Car {
	public int speed; // 접근제한자 = private , public int , int
	int gear; // private = 외부에서는 필드를 변경할수도 확인할수도없다. 접근금지 / 자기자신의 범위안에서만 범용할수있다
	...
	public boolean setColor(String c) {
		...
		return false;
	} // private 의 값을 변경하거나 설정하고싶을때 접근할때는 접근할조건의 방식조건값을 설정하고 그 조건값을 변경할수있는 설정값도 입력한다 
}
