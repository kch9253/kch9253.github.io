...
public class MusicPlayerGUI extends JFrame {
	...
	public MusicPlayerGUI(String user_id) throws SQLException {
		...
		URL url = getClass().getClassLoader().getResource("img/상단이미지.png");
		URL ur2 = getClass().getClassLoader().getResource("img/뒤로감기.png");
		URL ur3 = getClass().getClassLoader().getResource("img/재생.png");
		URL ur4 = getClass().getClassLoader().getResource("img/정지버튼.png");
		URL ur5 = getClass().getClassLoader().getResource("img/앞으로감기.png");
		URL ur6 = getClass().getClassLoader().getResource("img/흔들어.png");
		URL ur7 = getClass().getClassLoader().getResource("img/배경사진.jpg");
		URL ur8 = getClass().getClassLoader().getResource("img/휴지통.png");
		
		this.user_id = user_id;
		// --------------------------------------------------22-0726
		try {
			conn = DBUtil.getConnection();
			setTitle(PLdao.findUsersName(user_id) + "님의 플레이 리스트");
		} finally {
		...
		JLabel lbl_info = new JLabel(new ImageIcon(url));
		...
		JButton btnNewButton_3 = new JButton(new ImageIcon(ur2));
		...
		JButton startBtn = new JButton(new ImageIcon(ur3));
		...
		JButton stopBtn = new JButton(new ImageIcon(ur4));
		...
		JLabel lblNewLabel = new JLabel(new ImageIcon(ur6));
		...
		try {
			conn = DBUtil.getConnection();
			mp = PLdao.printPlaylist( user_id, data, mp);
		} finally {
			DBUtil.closeConn(conn);
		}
		...
		JButton deleteBtn = new JButton(new ImageIcon(ur8));
		...
		springLayout.putConstraint(SpringLayout.NORTH, allSelectBtn, 11, SpringLayout.SOUTH, scrollPane);
		springLayout.putConstraint(SpringLayout.SOUTH, allSelectBtn, -25, SpringLayout.SOUTH, btnNewButton_3);
		springLayout.putConstraint(SpringLayout.EAST, allSelectBtn, -6, SpringLayout.WEST, deleteBtn);
