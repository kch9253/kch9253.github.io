...
.map_wrap {position:relative;width:93%;height:800px;}
...
<body>
<div class="map_wrap">
    <div id="map" style="width:93%;height:100%;position:relative;overflow:hidden;"></div>
...
<br>
<button onclick="location.href='UserSecession.jsp'">회원탈퇴 테스트</button>
...
function displayPlaces(places) {
    ...
    for ( var i=0; i<places.length; i++ ) {
        ...
        var iwContent = '<div style="padding:5px;"> <a href="Login.jsp" style="color:blue" target="_blank" >정보보기</button>       </div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
        ...
        (function(marker, title) {
            ...
            kakao.maps.event.addListener(marker, 'mouseover', function() {
            	...
            	marker.infowindow.setContent(title);
...
<script src="../js/MainMenu.js">menu</script>
</body>
</html>