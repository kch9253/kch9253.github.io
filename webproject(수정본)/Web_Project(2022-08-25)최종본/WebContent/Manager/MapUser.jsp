...
function removeAllChildNods(el) {   
    ...
    <br>
    <br>
    <label>좌표ID값 :<input type="text" id="latclick" name="latclick" value="" > 
    <br>
    <br>
    <label>좌표위도 :<input type="text" id="lngclick" name="lngclick" value="" >
    <br>
    <br>
    <label>전화번호 :<input type="text" id="number" name="number" value="" > 
	<br>
	<br>
	<label>영업시간 :<input type="text" id="opentime" name="opentime" value="" > 
	<br>
	<br>
	<label>카테고리 :<input type="text" id="category" name="category" value="" > 
	<br>
	<br>
	<label>이미지 :<input type="url" id="img" name="img" value="" > 
