...
<div id="mySidenav" class="sidenav">
  ...
  <a href="./FavoriteSearch.jsp">즐겨찾기목록</a>  
  <a href="../MainMenu/UserChange.jsp">회원정보수정</a>
  <a href="../MainMenu/Userpasswordchange.jsp">비밀번호변경</a>
...
function displayPlaces(places) {
    ...
    for ( var i=0; i<places.length; i++ ) {
        ...
        (function(marker, pname, praddress, paddress, plat, plng, plat1, pname1, paddress1 ) {
...
//                 }
                ...
                if (praddress) {
                	...
                	document.getElementById('paddress1').value = paddress1; 
                } else {
                	document.getElementById('paddress').value = paddress; 
                }
            	document.getElementById('latclick').value = plat;
            	document.getElementById('latclick1').value = plat1;
        ...
        })(marker, places[i].place_name, places[i].road_address_name, places[i].address_name, places[i].y, places[i].x, places[i].y , places[i].place_name, places[i].address_name );
...
function removeAllChildNods(el) {   
    ...
    <h2> <정보보기> </h2>
    <!-- 위도 및 경도 좌표 및 위치정보 -->
    <label>상호명 :<input type="text" id="pname"  name="pname" value="" style="width: 200px" > 
    <br>
    <br>
    <label>주소 :<input type="text" id="paddress" name="paddress" value="" style="width: 200px" >  
    <br>
    <br>
    ...
    <br>
    <h2> <즐겨찾기등록> </h2>
    <form action="FavoriteUser.jsp" method="post">
    <label>아이디: <input type="text" id="userid" name="userid" style="width: 200px" value="<%=id %>"  >
	<br>
	<br>
    <label>좌표ID :<input type="text" id="latclick1" name="latclick" style="width: 200px" value="" >
    <br>
    <br>
    <label>상호명 :<input type="text" id="pname1" name="pname" style="width: 200px" value="" >
    <br>
    <br>
    <label>주소 :<input type="text" id="paddress1" name="paddress" style="width: 200px" value="" >
    <br>
    <br>   
	<input type="submit" value="즐겨찾기등록">    
    </div>
    </form>
    </center>
