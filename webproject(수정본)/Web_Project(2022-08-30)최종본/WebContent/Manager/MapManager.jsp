...
<div id="mySidenav" class="sidenav">
  ...
  <a href="../MapManager/MapSearch.jsp">맵검색&삭제</a>
  <a href="../MapManager/MapManagerUpdate.jsp">맵수정</a>
</div>
...
function checkValue() {
	...
	if(!form.latclick.value) {
		alert("좌표ID를 입력하세요.");
		return false;
	} 		
	if(!form.lngclick.value) {
		alert("위도를 입력하세요.");
		return false;
	} 		
	if(!form.pname.value) {
...
<form id="frm" name="userInfo" action="MapManager_DB.jsp" method="post" onsubmit="return checkValue()">

	<center>
	<h2> <정보저장> </h2>
    <label>좌표ID값 :<input type="text" id="latclick" name="latclick" value="${ param.latclick }" style="width: 400px"> 
    <br>
    <br>
    <label>좌표위도 :<input type="text" id="lngclick" name="lngclick" value="${ param.lngclick }" style="width: 400px">
    <br>
    <br>
    <label>상호명 :<input type="text" id="pname" name="pname" value="${ param.pname }" style="width: 400px" > 
    <br>
    <br>
    <label>주소 :<input type="text" id="paddress" name="paddress" value="${ param.paddress }" style="width: 400px" >  
    <br>
    <br>
     <label>전화번호 :<input type="text" id="number" name="number" value="${ param.number }" style="width: 400px"> 
	<br>
	<br>
	<label>영업시간 :<input type="text" id="opentime" name="opentime" value="${ param.opentime }" style="width: 400px"> 
	<br>
	<br>
	<label>카테고리 :<input type="text" id="category" name="category" value="${ param.category }" style="width: 400px"> 
	<br>
	<br>
	<label>이미지(URL입력) :<input type=url id="img" name="img" value="${ param.img }" style="width: 400px" >
	<br>
	<br> 
	<label>로드뷰 :<input type="url" id="route" name="route" value="https://map.kakao.com/link/roadview/" style="width: 400px"> /좌표ID,좌표위도 입력
	<br>
	<br>
	<label>홈페이지 :<input type="url" id="homepage" name="homepage" value="" style="width: 400px"> /인스타그램 주소입력
	<br>
	<br>
	<label>길찾기 :<input type="url" id="road" name="road" value="https://map.kakao.com/link/to/" style="width: 400px"> /상호명,좌표ID,좌표위도 입력
	<br>
	<br>
	<label>메뉴(URL입력) :<input type=url id="menu" name="menu" value="${ param.menu }" style="width: 400px" >
    <br>
    <br>
...
<%-- 	<label>좌표ID값 :<input type="text" id="latclick1" name="latclick" value="${ param.latclick }" style="width: 400px">  --%>
<!-- 	<br> -->
<!-- 	<br> -->
<%--     <label>전화번호 :<input type="text" id="number" name="number" value="${ param.number }" style="width: 400px">  --%>
<!-- 	<br> -->
