...
<body>
<!-- <form action="../Manager/test.jsp" method="post"> -->
<div class="map_wrap">
...
function displayPlaces(places) {
    ...
    for ( var i=0; i<places.length; i++ ) {
        ...
        var iwContent = '<div style="padding:5px;"> <a href="../Manager/test.jsp" style="color:blue" target="_blank" >정보보기</button>       </div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
