...
function idDelete(delID){
    ...
    //alert(delID);
    location.href = "deletefavorite.jsp?latclick=" + delID;   //get방식으로 삭제할아이디를 넘김
           
}

function testview(delID){
    
    //alert(delID);
    location.href = "testview.jsp?latclick=" + delID;   //get방식으로 삭제할아이디를 넘김
...
%>
   ...
   <!--
    ...
    ArrayList<favoriteDTO> list = dao.getMemberlist(keyField, keyWord);
    ...
    <table>
        <tr bgcolor="#E6E6E6">
        <th>아이디</th><th>좌표ID</th><th>상호명</th><th>주소</th><th><th>
        </tr>
    <%
...
<%--             <td><%=vo.getPaddress() %></td> --%>
			...
			<td><%=rs.getString("latclick") %></td>
			<td><%=rs.getString("pname") %></td>
			<td><%=rs.getString("paddress") %></td>
           	<td><input type="button" value="삭제" onclick="idDelete('<%=rs.getString("latclick") %>');"></td>
           	<td><input type="button" value="정보보기" onclick="testview('<%=rs.getString("latclick") %>');"></td>
<!--            	<td><input type="button" value="정보보기" onclick="location.href='testview.jsp'"></td> -->
        </tr>              
    <%
    }
     %>
...
<!--            	<input type="button" value="재검색" onclick="location.href='FavoriteSearch.jsp'"> -->
<!--            	<br> -->
<!--            	<br> -->
<!--             </form> -->
